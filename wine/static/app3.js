    ...
    for(var i = 0; i < 82; i++){
        container1.append("img")
            ...
            .on("mouseover", function() {
                ...
                var pic = d3.select(".item")
                    .attr("style", "width: 15px")
                    .attr("style", "-webkit-transform: translate(0,0)");
                
                console.log(current);
                
                pic.attr("style", "width: 215px")  
                    .attr("style", `-webkit-transform: translate(- + ${(current/81)*200}+ px, 0)`);
                ...
                d3.select(".item")
                    .attr("style", function(d, i) { 
                        ...
                        for (k = 1; k< data.length - i; k++) {
                            ...
                            var prevData = d3.select(this). data(k).order
                                // .attr("data-order", k)
                    ...
                    .attr("style", function(d, i) { 
                        ...
                        for (k = 1; k< data.length - i; k++) {
                            ...
                            return `-webkit-transform: translate(- ${prevData*leftdif} , 0)`;
